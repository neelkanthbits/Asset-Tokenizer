...
contract AssetTokenizationStorage {
    ...
    struct Token {
        ...
        bool privateVerificationList; // Should the token use private verification list or the owners'
    ...
    InitializeInterface
{
    ...
    function tokenizeAsset(
        ...
        //If you want to use private verification list then whitelist the owner
