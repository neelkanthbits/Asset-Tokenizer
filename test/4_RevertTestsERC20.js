...
contract('tokenize', (accounts) => {
  ...
  it("Checking Transfer with Both VerificationList -- Negative Test", async function () {
    ...
    console.log(
      "User whitelist (private List) status pre addition: ",
      status
    );
    ...
    console.log(
      "User whitelist (private List) status post addition: ",
      status2
    );
  ...
  it("Checking Transfer with private List Only -- Negative Test", async function () {
    ...
    console.log(
      "User whitelist (private List) status : ",
      status
    );
  ...
  describe('Adding From another user to private White List -- Negative Test', function() {
