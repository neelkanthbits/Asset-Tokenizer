/* Test file for AssetTokenization solidity contract */

const { token } = require("morgan");

// Import artifacts
const AssetTokenization = artifacts.require("./AssetTokenization.sol");
...
contract("AssetTokenization", function (accounts) {
  ...
  beforeEach(async function () {
    ...
    instance = await AssetTokenization.at(proxyAddress);
